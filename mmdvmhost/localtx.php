...
if (file_exists('/etc/pistar-css.ini')) {
    ...
    else { $callsignLookupSvc = "QRZ11"; }										// Set the default if its missing										// Set the default if its missing
} else {
    // Default values
    $callsignLookupSvc = "QRZ11";
}

// Safety net
if (($callsignLookupSvc != "QRZ") && ($callsignLookupSvc != "QRZ11")) { $callsignLookupSvc = "QRZ11"; }

// Setup the URL(s)
$idLookupUrl = "https://www.qrz11.com/app.php/cssearch?callsign=";
if ($callsignLookupSvc == "QRZ11") { $callsignLookupUrl = "https://www.qrz11.com/app.php/cssearch?callsign="; }
